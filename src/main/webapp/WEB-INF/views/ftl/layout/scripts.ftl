...
<script src="<@spring.url relativeUrl="/resources/js/jquery.ui.touch-punch.js"/>"></script>
...
<script src="<@spring.url relativeUrl="/resources/js/jquery.flot.pie.js"/>"></script>
<script src="<@spring.url relativeUrl="/resources/js/jquery.flot.stack.js"/>"></script>
<script src="<@spring.url relativeUrl="/resources/js/jquery.flot.resize.min.js"/>"></script>
...
<script src="<@spring.url relativeUrl="/resources/js/jquery.noty.js"/>"></script>

<script src="<@spring.url relativeUrl="/resources/js/jquery.elfinder.min.js"/>"></script>

<script src="<@spring.url relativeUrl="/resources/js/jquery.raty.min.js"/>"></script>

<script src="<@spring.url relativeUrl="/resources/js/jquery.iphone.toggle.js"/>"></script>

<script src="<@spring.url relativeUrl="/resources/js/jquery.gritter.min.js"/>"></script>

<script src="<@spring.url relativeUrl="/resources/js/jquery.imagesloaded.js"/>"></script>

<script src="<@spring.url relativeUrl="/resources/js/jquery.masonry.min.js"/>"></script>

<script src="<@spring.url relativeUrl="/resources/js/jquery.knob.modified.js"/>"></script>
