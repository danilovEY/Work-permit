    ...
    <div class="box span12">
        ...
        <div class="box-content">
            <ul class="nav tab-menu nav-tabs">
                <li class=""><a href="<@spring.url relativeUrl="/permit/edit/work?id=${permitId}"/>">Работа</a></li>
                <li class=""><a href="<@spring.url relativeUrl="/permit/edit/event?id=${permitId}"/>">Условия и мероприятия</a></li>
                <li class=""><a href="<@spring.url relativeUrl="/permit/edit/people?id=${permitId}"/>">Люди</a></li>
                <li class="active"><a href="<@spring.url relativeUrl="/permit/edit/history?id=${permitId}"/>">История</a></li>
            </ul>
