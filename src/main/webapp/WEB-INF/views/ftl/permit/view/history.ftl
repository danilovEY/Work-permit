    ...
    <div class="box span12">
        ...
        <div class="box-content">
            <ul class="nav tab-menu nav-tabs">
                <li class=""><a href="<@spring.url relativeUrl="/permit/view/work?id=${permit.id}"/>">Работа</a></li>
                <li class=""><a href="<@spring.url relativeUrl="/permit/view/event?id=${permit.id}"/>">Условия и мероприятия</a></li>
                <li class=""><a href="<@spring.url relativeUrl="/permit/view/people?id=${permit.id}"/>">Люди</a></li>
                <li class="active"><a href="<@spring.url relativeUrl="/permit/view/history?id=${permit.id}"/>">История и действия</a></li>
            </ul>
